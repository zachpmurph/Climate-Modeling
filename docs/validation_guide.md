...
Across all four fixed-parameter events, NSE ranges from `-0.0699` to `0.5584`
with a median of `0.3020`; percent bias is consistently negative from `-14.13%`
to `-9.17%`, while Pearson correlation remains `0.7360–0.8082`. This combination
